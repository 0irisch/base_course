...
plt.plot([248, 259], [475, 455], lw=2, color='w')
plt.savefig('slide_2_paint_image.png')
...
plt.plot([304, 320], [515, 530], lw=1.5, color='w')
plt.savefig('slide_2_paint_image.png')

plt.plot([320, 335], [530, 510], lw=1, color='w')
plt.savefig('slide_2_paint_image.png')
...
plt.plot([459, 469], [362, 353], lw=1, color='w')
plt.savefig('slide_2_paint_image.png')
...
plt.plot([475, 483], [345, 370], lw=1.5, color='w')
plt.savefig('slide_2_paint_image.png')
